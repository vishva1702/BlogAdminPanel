...
namespace BlogAdminPanel.Migrations
{
    ...
    [Migration("20250120084957_init4")]
    partial class init4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlogAdminPanel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "System",
                            CreatedOn = new DateTime(2025, 1, 20, 14, 19, 57, 364, DateTimeKind.Local).AddTicks(9498),
                            Email = "admin@blog.com",
                            IsActive = true,
                            IsDeleted = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEFiLkTESidBRH95IhcLz1rhgls17qGLSjOnD+cUlqsMYYfxazv4SJbVUXNnXw9kvNw==",
                            Role = "Admin",
                            UserName = "Admin"
                        });
                });
